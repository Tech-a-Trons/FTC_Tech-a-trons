...
// - port3 =
//##############################################################
package IntoTheDeep.References;
...
@TeleOp(name = "T2_TeleOp_V5", group = "ETAT")
public class T2_TeleOp_V5 extends LinearOpMode {
    //Hardware Map Names
...
//                SzoneSlide.setPosition(0.15);
            ...
            if ((gamepad1.dpad_right) && (!LS_motorRunning)) {
                int LS4_value = 400;
                LS_TargetPosition = ((int) (LS4_value * LS_TICKS_PER_MM));
                LeftLinearSlide.setTargetPosition((int) (LS4_value * LS_TICKS_PER_MM));
                RightLinearSlide.setTargetPosition((int) (LS4_value * LS_TICKS_PER_MM));
