...
@TeleOp(name = "T2_TeleOp_V2", group = "ETAT")
public class T2_TeleOp_V2 extends LinearOpMode {
    //Hardware Map Names
...
//            telemetry.update();
            ...
            if (gamepad2.x && !SzoneSlideExtended) {
                ...
                SzoneSlide.setPower(1.0);
                sleep(1700);
                SzoneSlideExtended = true;
                SzoneSlide.setPower(0);
            }
