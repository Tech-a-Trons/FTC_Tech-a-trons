...
//
//@Disabled
//@Autonomous(name = "ETAT_AUTO_v6_RIGHT", group = "ETAT")
////@TeleOp(name = "ETAT_AUTO_v6_RIGHT", group = "ETAT")
//public class ETAT_AUTO_v6_RIGHT extends LinearOpMode {
//    //Hardware Map Names
